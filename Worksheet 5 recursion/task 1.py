def sumEven(n): #this is all a-ok
    if n>0:
        if n%2 == 0:
            n = n+ sumEven(n-2)
            return n
...
thing = input("you wanna quit? (y/n)")
if thing == "y":
    print("ha wrong choice!!! ")
    def irritation(n):  # this is all a-ok
        print(n)
        n = irritation(n)


    print(irritation("""YOU SHOULD HAVE PRESSED NO!!! ( ͡° ʖ̯ ͡°)
                                    .....'',;;::cccllllllllllllcccc:::;;,,,''...'',,'..
